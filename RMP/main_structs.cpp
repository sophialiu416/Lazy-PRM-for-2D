...
//	        		     cv::line(image,Point(NodeList[NewPath.node_now].x,NodeList[NewPath.node_now].y),Point(NodeList[NewPath.node_next].x,NodeList[NewPath.node_next].y),Scalar(100,105,200),2, LINE_8, 0 );
